...
module.exports = {
    data : new SlashCommandBuilder()
        .setName('late')
        .setDescription('Logs the crosses of a user that is late')
    ...
    async execute(interaction, profileData){
        ...
        interaction.editReply(`You have logged ${serverNickname} for late attendance with ${amountOfCrosses} cross(es)`);
    },
};